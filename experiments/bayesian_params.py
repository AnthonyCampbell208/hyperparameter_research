...
def combination_exists_in_results(key, model_y, model_t, str_causal_model):
    results_file = f'results/{key}_bayesian_params.csv'
...
def main():
    ...
    # data_dict = {'ihdp':load_ihdp(), 'twin':load_twin()}
            ...
            for model_y  in my_list:
                ...
                for model_t in mt_list:
                    ...
                    try:
                        ...
                        #             continue
                                # set this combos params
                        param_y = get_bayesian_hyperparams_continuous(x_scaled, Y, model_y)
                        param_t = get_bayesian_hyperparams_discrete(x_scaled, T, model_t) if is_discrete else get_bayesian_hyperparams_continuous(x_scaled, T, model_t)
                        model_y.set_params(param_y)
                        ...
                        if i % 50 == 0:
                            ...
                            results_df.to_csv(f'results/{key}_bayesian_params.csv')
