...
def find_best_fold_mse_runtime(fold_models, ci_estimator_list):
    ...
    for ci in ci_estimator_list:
        ...
        best_models_mse[ci] = {'best_model_y' : fold_models[f'fold {fold_mse}']['model_y'], 'best_model_t' : best_fold_model_t_mse, 'Mse' : fold_models[f'fold {fold_mse}']['Mse'][ci]}
        best_models_time[ci] = {'best_model_y' : fold_models[f'fold {fold_time}']['model_y'], 'best_model_t' : best_fold_model_t_time, 'Runtime' : fold_models[f'fold {fold_time}']['Runtime'][ci]}
...
def main(ci_estimator_list, model_y, model_t, key, k):
    ...
    fold_models, total_run_time = get_models_during_k_folds(X, T, Y, k, ci_estimator_list, model_y, model_t, model_y_discrete=False, model_t_discrete=True)
    ...
    with open(results_file, mode='w', newline='') as csvfile:
        ...
        csvwriter.writerow(['Estimator', 'Fold', 'model_y', 'model_t', 'MSE', 'Runtime', 'Best first-stage models Mse', 'Best first-stage models Runtime', 'Best Mse', 'Best Runtime', 'Total Runtime'])
        ...
        csvwriter.writerow(['', '', '', '', '', '', '', '', '', '', total_run_time])
